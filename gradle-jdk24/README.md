# Snyk Gradle (jdk24)  Action

A [GitHub Action](https://github.com/features/actions) for using [Snyk](https://snyk.co/SnykGH) to check for
vulnerabilities in your Gradle-jdk24 projects. This Action is based on the [Snyk CLI][cli-gh] and you can use [all of its options and capabilities][cli-ref] with the `args`.
  ...
  security:
    ...
    steps:
      ...
      - name: Run Snyk to check for vulnerabilities
        uses: snyk/actions/gradle-jdk24@master
        env:
