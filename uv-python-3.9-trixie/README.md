...
# Snyk uv (python-3.9-trixie)  Action



A [GitHub Action](https://github.com/features/actions) for using [Snyk](https://snyk.co/SnykGH) to check for
vulnerabilities in your uv-python-3.9-trixie projects. This Action is based on the [Snyk CLI][cli-gh] and you can use [all of its options and capabilities][cli-ref] with the `args`.
  ...
  security:
    ...
    steps:
      ...
      - name: Run Snyk to check for vulnerabilities
        uses: snyk/actions/uv-python-3.9-trixie@master
        env:
